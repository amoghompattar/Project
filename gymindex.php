  ...
  <body>
    <header class="header">
      <nav>
        <div class="nav__header">
          <div class="nav__logo">
            <a href="#"><img src="gym images/athena-gym-high-resolution-logo-black.png" alt="logo" />ATHENA GYM</a>
          </div>
      ...
      <div class="section__container header__container" id="home">
        <div class="header__image">
          <img src="gym images/pexels-pixabay-163403.jpg" alt="header" />
        </div>
    ...
    <section class="section__container about__container" id="about">
      <div class="about__image">
        <img class="about__bg" src="C:\Users\HP\Desktop\gymwebsite\pexels-victor-freitas-791763.jpg" alt="bg" />
        <img src="gym images/pexels-tima-miroshnichenko-6388368.jpg" alt="about" />
      </div>
    ...
    <section class="section__container class__container" id="class">
      ...
      <div class="class__grid">
        <div class="class__card">
          <img src="gym images/pexels-alesia-kozik-7289248.jpg" alt="bg" class="class__bg" />
          <img src="gym images/pexels-alesia-kozik-7289248.jpg" alt="class" />
        ...
        <div class="class__card">
          ...
          <img src="gym images/emily-sea-coiWR0gT8Cw-unsplash.jpg" alt="class" />
          <div class="class__content">
        ...
        <div class="class__card">
          <img src="assets/dot-bg.png" alt="bg" class="class__bg" />
          <img src="gym images/hIIT.jpg" alt="class" />
          <div class="class__content">
            <h4>HIIT</h4>
        ...
        <div class="class__card">
          <img src="assets/dot-bg.png" alt="bg" class="class__bg" />
          <img src="gym images/andreea-boncota-icxORkp1Yv0-unsplash.jpg" alt="class" />
          <div class="class__content">
            <h4>Group Fitness</h4>
            <p>Zumba or Dance</p>
          </div>
    ...
    <section class="section__container trainer__container" id="trainer">
      ...
      <div class="trainer__grid">
        <div class="trainer__card">
          <img src="gym images/pexels-andrea-piacquadio-3838389.jpg" alt="trainer" />
        </div>
        <div class="trainer__card">
        ...
        <div class="trainer__card">
          <img src="gym images/pexels-tima-miroshnichenko-5327487.jpg" alt="trainer" />
        </div>
        <div class="trainer__card">
          <div class="trainer__content">
            <h4>Mark Harris</h4>
        ...
        <div class="trainer__card">
          <img src="gym images/lutchenca-medeiros-FcSYIRwh4Bw-unsplash.jpg" alt="trainer" />
        </div>
        <div class="trainer__card">
          <div class="trainer__content">
            <h4>Emily Davis</h4>
      ...
      <div class="price__grid">
        <div class="price__card">
          <div class="price__content">
            ...
            <p>Personalized meal plan</p>
            <p>Access to our online community</p>
          </div>
        ...
        <div class="price__card">
          ...
          <button class="btn">$380.00</button>
        </div>
      </div>
    </section>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="client__card">
              <img src="assets/dumbell.jpg" alt="client" />
      ...
      <div class="section__container footer__container">
        <div class="footer__col">
          ...
          <div class="footer__socials">
            ...
            <a href="https://twitter.com/login"><i class="ri-twitter-fill"></i></a>
          </div>
        </div>
        <div class="footer__col">
          <h4>Company</h4>
        ...
        <div class="footer__col">
          <h4>Contact</h4>
          <div class="footer__links">
            <a href="#">Contact Us (0836 275262)</a>
